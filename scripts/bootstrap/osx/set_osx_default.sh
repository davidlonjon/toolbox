...
# https://news.ycombinator.com/item?id=3779895
...
e_header 'Setting Up Mac OSX Default preferences - "Lucky" David Lonjon'
...
# echo $HOME
sudo tar -pzcf ./backups/preferences-`date "+%Y%m%d-%H%M%S"`.tar.gz $HOME/Library/Preferences /Library/Preferences

e_success "Backup done !"

e_arrow "Changing the default MAC OSX settings to more sensible ones"
...
# sudo scutil --set ComputerName "David Macbook Pro"
# sudo scutil --set HostName "David Macbook Pro"
# sudo scutil --set LocalHostName "David-Macbook-Pro"
# sudo defaults write /Library/Preferences/SystemConfiguration/com.apple.smb.server NetBIOSName -string "David-Macbook-Pro"
...
# Disabled as it makes it too slow when too much files need deletion
